\hypertarget{_attribute_info_8hpp}{}\section{Referência ao ficheiro Attribute\+Info.\+hpp}
...
Diagrama de dependências de inclusão para Attribute\+Info.\+hpp\+:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=253pt]{_attribute_info_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{_attribute_info_8hpp__dep__incl}
\end{center}
\end{figure}
